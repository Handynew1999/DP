...
usek <- "Starek/zeleznice/Belusa-Puchov/Zmluvný rozpoèet/109 UCS 43b vyplnovaci.xlsx"
...
write_xlsx(df_fullcomplete,"Starek/zeleznice/Belusa-Puchov/Zmluvný rozpoèet/Belusa_puchov_UHP_zmluvny.xlsx")

################TEORETICKY ROZPOÈET##############################################
usek <- "Starek/zeleznice/Belusa-Puchov/Teoretický rozpoèet/109_UCS 43b_vyceneny.xls"
nazvy <- excel_sheets(usek)
data <- lapply(nazvy, function(X) readxl::read_excel(usek, sheet = X, skip = 0))
names(data) <- nazvy
colnames <- c("objekt", "kod_kp", "nazov_polozky","jednotka","mnozstvo", "jednotkova_cena","cena_celkom")
...
write_xlsx(df_fullcomplete,"Starek/zeleznice/Belusa-Puchov/Teoretický rozpoèet/Belusa_puchov_UHP_teoretický.xlsx")
